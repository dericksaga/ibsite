...
$busca = "SELECT * FROM promocoes_dados where id <> 1 order by id desc";
...
?>
<h3>Lista de Promo&ccedil;&otilde;es </h3> 
...
<table width="440" border=0 align="center" cellpadding=0 cellspacing=0> 
    ...
    <td width="240" bgcolor="#C0C0C0"><b>Titulo</b></td> 
	   <td width="66" bgcolor="#C0C0C0"><b>Data final</b></td>
...
<? while ($dados=mysql_fetch_array($limite)) {?>
         ...
         <tr align="center" bgcolor="<? echo $bgcolor; ?>"> 
			...
			<td align="center" bgcolor="<? echo $bgcolor; ?>"><? $data=explode("-",$dados[data]); echo "$data[2]/$data[1]/$data[0]";?></td>
			<!--
            <td align="center">
			<?
			$sql = mysql_query("SELECT * FROM promocoes_comentarios WHERE id_noticia='$dados[id]'");
			$total = mysql_num_rows($sql);
			if($total > 0){
			echo "<a href='?pg=../promocoes/comentarios.php&id=$dados[id]'><font color='green'>Ver Comentários</font></a>";
			} else {
			echo "<font color='red'>Sem Comentários</font>";
			}
			?>
			</td>-->
            <td width="38" align="center"><a href="?pg=../estrutura/promocoes/alterar_form.php&id=<? echo $dados[id]; ?>"><img src="../images/admin/botao_edit.png" alt="Alterar" border="0"></a></td> 
            <td width="40" align="center"><a href="javascript:confirmaExclusao('?pg=../estrutura/promocoes/excluir_db.php&id=<? echo $dados[id]; ?>')"><img src="../images/admin/botao_drop.png" alt="Excluir" border="0"></a></td> 
        </tr> 
        </tr> 
