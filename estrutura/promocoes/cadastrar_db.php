<?
$nome = $_POST[nome];
$data1 = explode("/", $_POST[email]);
$email = "$data1[2]-$data1[1]-$data1[0]";
...
$sql = "INSERT INTO promocoes_dados VALUES ('', '$categoria', '$nome', '$email', '$data', '$titulo', '$subtitulo', '$texto', '', '$fotos_extras', '$alinhamento_foto', '$borda', '$creditos_foto', '$status', '$largura_foto', '$altura_foto')";
$sql = mysql_query($sql);

$id_recuperado = mysql_insert_id();

// inicia criação de pasta
$pasta = @mkdir("../images/promocoes/$id_recuperado", 0777);
         @chmod("../images/promocoes/$id_recuperado", 0777);
// fim da criação da pasta
$uploaddir="../images/promocoes/$id_recuperado/";
...
$var1 = mysql_query("update promocoes_dados set foto01='$varfoto01' where id='$id_recuperado'");
?>
<h3>Promo&ccedil;&atilde;o cadastrada com sucesso!</h3>
