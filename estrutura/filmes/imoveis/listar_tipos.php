...
$busca = "SELECT * FROM imoveis_tipos order by nome asc";
...
<? while ($dados=mysql_fetch_array($limite)) {?>
         ...
         <tr align="center" bgcolor="<? echo $bgcolor; ?>"> 
            ...
            <td width="38" align="center"><a href="?pg=../estrutura/imoveis/alterar_form_tipos.php&id=<? echo $dados[id]; ?>"><img src="../images/admin/botao_edit.png" alt="Alterar" border="0"></a></td>
            <td width="40" align="center"><a href="javascript:confirmaExclusao('?pg=../estrutura/imoveis/excluir_tipos_db.php&id=<? echo $dados[id]; ?>')"><img src="../images/admin/botao_drop.png" alt="Excluir" border="0"></a></td>
        </tr> 
        </tr> 
