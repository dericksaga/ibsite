...
$id = $_GET[id];
$sql = mysql_query("SELECT * FROM imoveis_tipos WHERE id='$id'");
while ($dados=mysql_fetch_array($sql)) {
$status = "$dados[status]";
?>

<h3>Alteração de Conte&uacute;do</h3>
<form action='?pg=../estrutura/imoveis/alterar_tipos_db.php' method='post' enctype="multipart/form-data" name="form">
...
<? }?>
        ...
        <tr> 
          <td width="438" align="right" valign="middle" style="border-bottom:1px solid #cccccc"><strong>Tipo:</strong></td>
