...
<table width="100%" border="0" cellspacing="5" cellpadding="0" style="border:1px solid #9b9b9b;" class="texto">
  <tr>
    <td width="40%"><img src="images/filtrar.jpg" align="middle" />Ordenar por: <span class="marrom"><a href="?pg=imoveis&amp;ordem=valor<?=$complemento?>">&raquo; Valor</a></span></td>
    <td><div align="center" class="marrom"><a href="?pg=busca"><u>Busca Avan&ccedil;ada</u></a></div></td>
  </tr>
</table>
<br>
...
<table width="421" border=0 align="center" cellpadding=0 cellspacing=0> 
  <tr align="center">
    <td width="70" bgcolor="#FFFFFF" style="padding-top:2px; padding-bottom:2px;"><b class="texto">C&oacute;digo</b></td> 
