...
<Table border="0" align="center" cellpadding="2" cellspacing="0" style="border: 1px solid <? echo $cortexto?>">
  <TR align="center" bgcolor="<? echo $corcelula1?>"> 
    ...
    <TD width="80" height="15" style="border-right: 1px solid <? echo $corcelula2?>"><font color="<? echo $cortexto?>" size="<? echo $tfonte?>" face="<? echo $fonte?>"><strong>RENOMEAR</strong></font></TD>
  </TR>
  <?
if($caminho == ""){
 ...
 if (!is_dir($file)){?>
  ...
  <tr bgcolor="<? echo $corcelula2?>"> 
    <td valign="middle" style="border-right: 1px solid <? echo $corcelula1?>"><font color="<? echo $cortexto?>" size="<? echo $tfonte?>" face="<? echo $fonte?>"> 
      <? if($tipo == "dir"){ echo "<a href='?acao=fotos-alterar&caminho=$caminho/$file'><img src='../eventos/images/icone_pastinha.gif' width='16' height='14' border='0'> $file</a>";}
else { echo "<a href='$caminho/$file' target='_blank'><img src='../eventos/images/icone_img.gif' width='16' height='16' border='0'> $file</a>";}?>
      </font></strong> </font></td>
    <td align="center" valign="middle" style="border-right: 1px solid <? echo $corcelula1?>"><font color="<? echo $cortexto?>" size="<? echo $tfonte?>" face="<? echo $fonte?>"><a href="?acao=arquivo-renomeia01&caminho=<? echo $caminho?>&nomeantigo=<? echo $file?>">Renomear</a></font></td>
  </tr>
  <?
 }
}
