<? $cat = $_GET[cat];?>
<form action='?pg=../estrutura/filmes/cadastrarcat_db.php' method='post' enctype="multipart/form-data" name="form">
  <h3>Cadastro de Programa</h3>
...
<table width="440" border="0" align="center" cellpadding="2" cellspacing="0">
    ...
    <? }?>
    <tr>
      <td width="140" align="right" valign="middle" style="border-bottom:1px solid #cccccc">Nome do programa: </td>
