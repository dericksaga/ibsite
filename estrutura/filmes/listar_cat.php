...
$busca = "SELECT * FROM filmes_categorias order by nome asc";
...
<table width="440" border=0 align="center" cellpadding=0 cellspacing=0> 
    ...
    <td width="240" bgcolor="#C0C0C0"><b>Categoria</b></td> 
...
<? while ($dados=mysql_fetch_array($limite)) {?>
         ...
         <tr align="center" bgcolor="<? echo $bgcolor; ?>"> 
			...
			<?
				$sql3 = mysql_query("SELECT * FROM filmes_cidades where id = $dados[cidade]");
				$dados3=mysql_fetch_array($sql3);
			?>
            <td align="left" style=" color:<?=$dados[cor]?>"><?=$dados[nome]?></td> 
			<!--
            <td align="center">
			<?
			$sql = mysql_query("SELECT * FROM filmes_comentarios WHERE id_noticia='$dados[id]'");
			$total = mysql_num_rows($sql);
			if($total > 0){
			echo "<a href='?pg=../filmes/comentarios.php&id=$dados[id]'><font color='green'>Ver Comentários</font></a>";
			} else {
			echo "<font color='red'>Sem Comentários</font>";
			}
			?>
			</td>-->
            <td width="38" align="center"><a href="?pg=../estrutura/filmes/alterar_form_cat.php&id=<? echo $dados[id]; ?>"><img src="../images/admin/botao_edit.png" alt="Alterar" border="0"></a></td>
            <td width="40" align="center"><a href="javascript:confirmaExclusao('?pg=../estrutura/filmes/excluir_cat_db.php&id=<? echo $dados[id]; ?>')"><img src="../images/admin/botao_drop.png" alt="Excluir" border="0"></a></td>
        </tr> 
        </tr> 
