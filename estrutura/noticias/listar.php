...
$busca = "SELECT * FROM noticias_dados where id <> 1 order by id desc";
...
<table width="440" border=0 align="center" cellpadding=0 cellspacing=0> 
    ...
    <td width="240" bgcolor="#C0C0C0"><b>Titulo</b></td> 
	   <td width="66" bgcolor="#C0C0C0"><b>Categoria</b></td>
...
<? while ($dados=mysql_fetch_array($limite)) {?>
         ...
         <tr align="center" bgcolor="<? echo $bgcolor; ?>"> 
			...
			<td align="center" bgcolor="<? echo $bgcolor; ?>"><? $sql2 = mysql_query("SELECT * FROM noticias_categorias where id='$dados[idcat]'");
            ...
            <td width="38" align="center"><a href="?pg=../estrutura/noticias/alterar_form.php&id=<? echo $dados[id]; ?>"><img src="../images/admin/botao_edit.png" alt="Alterar" border="0"></a></td> 
