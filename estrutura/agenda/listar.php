...
$busca = "SELECT * FROM agenda order by data asc";
...
<table width="440" border=0 align="center" cellpadding=0 cellspacing=0> 
    ...
    <td width="240" bgcolor="#C0C0C0"><b>Evento</b></td> 
...
<? while ($dados=mysql_fetch_array($limite)) {?>
         ...
         <tr align="center" bgcolor="<? echo $bgcolor; ?>"> 
            ...
            <td align="left"> <? $data=explode("-",$dados[data]);
								 echo "<b>$data[2]/$data[1]/$data[0] - ".$dados[titulo]."</b>";
								 echo "<br />".$dados[local];
							  ?> </td> 
			<!--
            <td align="center">
			...
			if($total > 0){
			echo "<a href='?pg=../agenda/comentarios.php&id=$dados[id]'><font color='green'>Ver Comentários</font></a>";
			} else {
			echo "<font color='red'>Sem Comentários</font>";
			}
			?>
			</td>-->
            <td width="38" align="center"><a href="?pg=../estrutura/agenda/alterar_form.php&id=<? echo $dados[id]; ?>"><img src="../images/admin/botao_edit.png" alt="Alterar" border="0"></a></td> 
            <td width="40" align="center"><a href="javascript:confirmaExclusao('?pg=../estrutura/agenda/excluir_db.php&id=<? echo $dados[id]; ?>')"><img src="../images/admin/botao_drop.png" alt="Excluir" border="0"></a></td> 
        </tr> 
        </tr> 
