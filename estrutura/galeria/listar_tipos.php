...
$busca = "SELECT * FROM fotos_galerias order by id desc";
...
?>
<h3>Rela&ccedil;&atilde;o de Galerias</h3> 
...
<table width="440" border=0 align="center" cellpadding=0 cellspacing=0> 
    ...
    <td colspan="3" bgcolor="#C0C0C0"><b>A&ccedil;&otilde;es</b></td> 
	   <!-- <td width="90" bgcolor="#C0C0C0"><b>Coment&aacute;rios</b></td>-->    </tr> 
...
<? while ($dados=mysql_fetch_array($limite)) {?>
         ...
         <tr align="center" bgcolor="<? echo $bgcolor; ?>"> 
            ...
            <td width="40" align="center"><a href="?pg=../estrutura/galeria/administrar.php&amp;id=<? echo $dados[id]; ?>"><img src="../images/admin/camera-icon.gif" alt="Alterar" border="0" /></a></td> 
			<!--
            <td align="center">
			<?
            ...
            <td width="38" align="center"><a href="?pg=../estrutura/galeria/alterar_form_tipos.php&id=<? echo $dados[id]; ?>"><img src="../images/admin/botao_edit.png" alt="Alterar" border="0"></a></td>
            <td width="40" align="center"><a href="javascript:confirmaExclusao('?pg=../estrutura/galeria/excluir_tipos_db.php&id=<? echo $dados[id]; ?>')"><img src="../images/admin/botao_drop.png" alt="Excluir" border="0"></a></td>
        </tr> 
        </tr> 
