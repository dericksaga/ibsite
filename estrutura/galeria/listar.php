...
$busca = "SELECT * FROM blog_dados order by id desc";
...
?>
<h3>Relação de Blogs Cadastrados </h3> 
...
<table width="550" border=0 align="center" cellpadding=0 cellspacing=0> 
    ...
    <td width="351" bgcolor="#C0C0C0"><b>Aniversariante</b></td> 
	   <td width="47" bgcolor="#C0C0C0"><b></b></td>
	   <!-- <td width="90" bgcolor="#C0C0C0"><b>Coment&aacute;rios</b></td>-->
	    <td width="92" bgcolor="#C0C0C0"><div align="center"><b>Editar</b></div></td> 
    </tr> 
...
<? while ($dados=mysql_fetch_array($limite)) {?>
         ...
         <tr align="center" bgcolor="<? echo $bgcolor; ?>"> 
            ...
            <td align="center"><a href="?pg=../estrutura/imoveis/mandafotos.php&recupera=<?=$dados[id]?>"><img src="../images/admin/botao_edit.png" alt="Alterar" border="0"></a><a href="javascript:confirmaExclusao('?pg=../estrutura/imoveis/excluir_db.php&amp;id=<? echo $dados[id]; ?>')"><img src="../images/admin/botao_drop.png" alt="Excluir" border="0" /></a></td> 
  </tr> 
        </tr> 
