...
Modalbox.Methods = {
	...
	options: {
		...
		overlayOpacity: 0.75, // Default overlay opacity
		overlayDuration: .50, // Default overlay fade in/out duration in seconds
		slideDownDuration: 0.55, // Default Modalbox appear slide down effect in seconds
		slideUpDuration: 0.35, // Default Modalbox hiding slide up effect in seconds
		resizeDuration: .35, // Default resize duration seconds
		inactiveFade: true, // Fades MB window on inactive state
		loadingString: "Aguarde. Carregando...", // Default loading string message
		closeString: "Fechar Janela", // Default title attribute for close window link
		params: {},
