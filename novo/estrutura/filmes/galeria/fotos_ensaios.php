  ...
  <tr>
    <td colspan="2" align="right" valign="top"> 
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="155" height="180" align="center" valign="top"><?
$handle = opendir($dir);
$ext = "jpg";
$indice = 0;
$ipp = 6;
...
$inicio = $pg * $ipp;
$thumb="thumbs.php?w=145&h=25&imagem=";
...
//echo $page;
?>
<a href="zoom_ensaios.php?id=<? echo $id?>&cidade=<? echo $cidade?>&page=<? echo "$cont";?>" target="exibe_fotos"><img src="<? echo "$thumb$dir$imagens[$i]"; ?>" border="0" style="border:1px solid #000000;FILTER: alpha(opacity=100)" onClick="makevisible(this,0)" onmouseover="makevisible(this,0)" onmouseout="makevisible(this,1)"></a>
...
<!--          <td width="30%" height="20" align="left" valign="top"><font color="#000000"><strong> 
          ...
          <td width="100%" align="center" valign="top"><font color="#000000"> <strong>
            <? 
			echo "Pgs: ";
			for($i=0; $i<$paginas; $i++){
$url = "?id=$id&cidade=$cidade&pg=$i";
  if ($i==$pg) {
  echo "<font color='#FFFFFF' style='BACKGROUND-COLOR: #003366'>&nbsp;".($i+1)."&nbsp;</font> ";
  } else {
