...
<? while ($dados=mysql_fetch_array($limite)) {?>
         ...
         <tr align="center" bgcolor="<? echo $bgcolor; ?>"> 
            ...
            <td width="40" align="center"><a href="javascript:confirmaExclusao('?pg=../estrutura/conteudo/excluir_db.php&id=<? echo $dados[id]; ?>')"><img src="../images/admin/botao_drop.png" alt="Excluir" border="0"></a></td> 
        </tr>
<tr><td height="5" colspan="6"></td></tr>
...
?>
         <tr align="center" bgcolor="<? echo $bgcolor; ?>">
           ...
           <td><a href="javascript:confirmaExclusao('?pg=../estrutura/conteudo/excluir_db.php&amp;id=<? echo $dados2[id]; ?>')"><img src="../images/admin/botao_drop.png" alt="Excluir" border="0" /></a></td>
         </tr> 
<tr><td height="5" colspan="6"></td></tr>
<tr background="../imagens/layout/barrinha_divisao_horizontal.gif"><td height="1" colspan="6" background="../images/layout/barrinha_divisao_horizontal.gif"></td>
</tr>
...
<?
    ...
    ?>
             <tr align="center" bgcolor="<? echo $bgcolor; ?>">
               ...
               <td><a href="javascript:confirmaExclusao('?pg=../estrutura/conteudo/excluir_db.php&amp;id=<? echo $dados3[id]; ?>')"><img src="../images/admin/botao_drop.png" alt="Excluir" border="0" /></a></td>
             </tr> 
<tr><td height="5" colspan="6"></td></tr>
<tr background="../imagens/layout/barrinha_divisao_horizontal.gif"><td height="1" colspan="6" background="../images/layout/barrinha_divisao_horizontal.gif"></td>
</tr>
