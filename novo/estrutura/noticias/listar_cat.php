...
<? while ($dados=mysql_fetch_array($limite)) {?>
         ...
         <tr align="center" bgcolor="<? echo $bgcolor; ?>"> 
			...
			<?
				$sql3 = mysql_query("SELECT * FROM noticias_cidades where id = $dados[cidade]");
            ...
            <td width="38" align="center"><a href="?pg=../estrutura/noticias/alterar_form_cat.php&id=<? echo $dados[id]; ?>"><img src="../images/admin/botao_edit.png" alt="Alterar" border="0"></a></td>
            <td width="40" align="center"><a href="javascript:confirmaExclusao('?pg=../estrutura/noticias/excluir_cat_db.php&id=<? echo $dados[id]; ?>')"><img src="../images/admin/botao_drop.png" alt="Excluir" border="0"></a></td>
        </tr> 
        </tr> 
