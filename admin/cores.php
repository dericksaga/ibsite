...
<title>Galeria Brasil v2.0</title>
<body leftmargin="2" topmargin="2" bgcolor="#CCCCCC">
<? $id = $_GET[id];?>

<? if($_GET[campo] == cortexto){?>
...
function Set(color){
  window.open('index.php?pg=gal-configurar.php&pag=form&id=<? echo $id?>&novacortexto=' + color, 'pai');
  window.close();
}
</script>
<? }?>

<? if($_GET[campo] == coronmouse){?>
<script language="javascript">
function View(color) {                  // preview color
  document.all.ColorPreview.style.backgroundColor = '#' + color;
  document.all.ColorHex.value = '#' + color;
...
function Set(color){
  window.open('index.php?pg=gal-configurar.php&pag=form&id=<? echo $id?>&novacoronmouse=' + color, 'pai');
  window.close();
}
</script>
<? }?>

<? if($_GET[campo] == corcelula1){?>
<script language="javascript">
function View(color) {                  // preview color
  document.all.ColorPreview.style.backgroundColor = '#' + color;
  document.all.ColorHex.value = '#' + color;
...
function Set(color){
  window.open('index.php?pg=gal-configurar.php&pag=form&id=<? echo $id?>&novacorcelula1=' + color, 'pai');
  window.close();
}
</script>
<? }?>

<? if($_GET[campo] == corcelula2){?>
<script language="javascript">
function View(color) {                  // preview color
  document.all.ColorPreview.style.backgroundColor = '#' + color;
  document.all.ColorHex.value = '#' + color;
...
function Set(color){
  window.open('index.php?pg=gal-configurar.php&pag=form&id=<? echo $id?>&novacorcelula2=' + color, 'pai');
  window.close();
}
</script>
<? }?>

<? if($_GET[campo] == corfundosite){?>
<script language="javascript">
function View(color) {                  // preview color
  document.all.ColorPreview.style.backgroundColor = '#' + color;
  document.all.ColorHex.value = '#' + color;
...
function Set(color){
  window.open('index.php?pg=gal-configurar.php&pag=form&id=<? echo $id?>&novacorfundosite=' + color, 'pai');
  window.close();
}
</script>
<? }?>
...
<form method="post" target="pai">
  <table border=0 cellspacing=0 cellpadding=4 width=100%>
    <tr bgcolor="#CCCCCC"> 
      <td valign=center> 
        <div style="background-color: #000000; padding: 1; height: 21px; width: 50px"><div id="ColorPreview" style="height: 100%; width: 100%"></div></div></td>
      <td valign=center> 
        <input type="text" name="ColorHex" value="" size=7 style="font-size: 12px"></td>
      <td><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Clique sobre 
        a<br>
        cor desejada!</font></td>
 </tr>
</table>
